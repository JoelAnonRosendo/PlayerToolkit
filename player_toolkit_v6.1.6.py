...
import json
# NUEVO: Para logging de errores de inicio
import traceback
...
if __name__ == "__main__":
    try:
        ...
        # NUEVO: Bloque para capturar cualquier error fatal durante el inicio
        ...
        with open(error_log_path, "a", encoding="utf-8") as f:
            ...
            f.write("\n\n")
        # Para que el usuario vea el error si se ejecuta desde consola
        traceback.print_exc()